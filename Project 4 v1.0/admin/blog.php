...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form class="quote" action="./update/update_blog.php" method="post">
    <section id="main-experience1" style="padding: 20px;">
      <div class="container-exp">
        <article id="main_exp1" style="padding-left: 20px;">
          ...
          <p><textarea rows = "5" cols="120" type="text" name="Blog_P0"><?php echo $blog_row[0]?></textarea></p>
        </article>
      </div>
      </section>
      <br>
      ...
      <section id="main-experience2" style="padding: 20px;">
        ...
        <article id="main_exp2" style="padding-left: 20px;">
          ...
          <p><textarea rows = "5" cols="120" type="text" name="Blog_P1"><?php echo $blog_row[1]?></textarea></p>
        </article>
      </div>
    </section>
